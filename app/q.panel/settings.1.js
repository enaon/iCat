...
ew.face[0] = {
	...
	ref1: function(i) {
		//"jit";
		ew.UI.btn.img("bar", "_bar", 1, "q.panel", 0, i == 1 ? 11 : 2, 0);
		ew.UI.btn.img("bar", "_bar", 2, "apps", 0, i == 2 ? 11 : 2, 0);
		ew.UI.btn.img("bar", "_bar", 3, "dash", 0, i == 3 ? 11 : 2, 0);
	},
	ref: function(s) {
		//"jit";
		ew.UI.btn.img("bar", "_bar", 1, "q.panel", 0, ew.face[0].page == "set" || ew.face[0].page == "theme" ? 11 : 2, 0);
		ew.UI.btn.img("bar", "_bar", 2, "apps", 0, ew.face[0].page == "app" ? 11 : 2, 0);
