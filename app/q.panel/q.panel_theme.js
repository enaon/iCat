...
ew.UI.ele.ind(0, 0, 0);
ew.UI.c.start(1, 0);
ew.UI.btn.img("main", "_2x3", 1, "themes.face", "FACE", 11, 6, 1);
ew.UI.btn.c2l("main", "_2x3", 2, "SIZE", ew.UI.size.txt * 100, 15, 6); //4

ew.UI.btn.c2l("main", "_2x3", 3,  "OFF", tm,15, 6);
ew.UI.btn.img("main", "_2x3", 4, "haptic.face", "VIBR", ew.def.face.buzz ? 15 : 3, ew.def.face.buzz ? 4 : 1);
ew.UI.btn.img("main", "_2x3", 5, "txt.face", "TXT", ew.def.face.txt ? 15 : 3, ew.def.face.txt ? 4 : 1);
ew.UI.btn.img("main", "_2x3", 6, "info.face", "INFO", ew.def.face.info ? 15 : 3, ew.def.face.info ? 4 : 1);
ew.UI.c.end();
