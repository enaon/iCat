...
face[0] = {
	...
	spdF: function(){
		...
		this.g.setCol(0,(euc.dash.alrt.spd.cc==1)?0:this.spdC[euc.dash.alrt.spd.cc]);
		
		this.g.fillRect(this.pos.spd[0],this.pos.spd[1],this.pos.spd[2],this.pos.spd[3]);
		this.g.setCol(1,(euc.dash.alrt.spd.cc==1)?13:15);
	...
	ampF: function(){
		...
		this.g.setCol(0,this.ampC[euc.dash.alrt.amp.cc]);
	...
	tmpF: function(){
		...
		this.g.setCol(0,this.tmpC[euc.dash.alrt.tmp.cc]);
		this.g.fillRect(this.pos.btn1[0],this.pos.btn1[1],this.pos.btn1[2],this.pos.btn1[3]);
		this.g.setCol(1,15);
	...
	spLF: function(){
		...
		this.g.setCol(0,(euc.dash.alrt.spd.tilt.val<=face[0].buff.spdL)?1:7);	
	...
	amLF: function(){
		...
		this.g.setCol(1,(1<euc.dash.alrt.amp.cc)?7:1);
		this.g.fillRect(this.pos.topl[0],this.pos.topl[1],this.pos.topl[2],this.pos.topl[3]);       
		this.g.setCol(0,15);
	...
	pwrF: function(){
		...
		this.g.setCol(1,(50<=euc.dash.live.pwm)?(80<=euc.dash.live.pwm)?7:13:15);
	...
	vltF: function(){
		...
		this.g.setCol(0,this.batC[euc.dash.alrt.bat.cc]);
