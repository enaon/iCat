...
face[0] = { 
  ...
  init: function(o){ 
	this.maker={
		...
		begode:["Begode","BG",[{ namePrefix: 'GotWay' }],"ffe0"],
		inmotionV10:["InmotionV10","V10",[{ namePrefix: 'V' }],"ffb0"],
		inmotionV11:["InmotionV11","V11",[{ namePrefix: 'V11' }],"ffe0"],
		inmotionV12:["InmotionV12","V12",[{ namePrefix: 'V12' }],"ffe0"],
		veteran:["Veteran","SM","ffe0"],
		ninebotE:["NinebotE","E+", [{ namePrefix: 'NOC' }, { namePrefix: 'NOE' }, { namePrefix: 'NOP' }],"ffe0"],
		ninebotS:["NinebotS","S2",[{ namePrefix: 'N1' }],"e7fe"],
		ninebotZ:["NinebotZ","Z10",[{ namePrefix: 'N3' }],"e7fe"]
	};
